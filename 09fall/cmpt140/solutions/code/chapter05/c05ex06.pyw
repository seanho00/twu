...
def main():
    ...
    t2 = Text(Point(5,7.5), "Enter the information below and then click anywhere graph it")
    t2.setSize(14)
    t2.draw(win)

    t3 = Text(Point(3,6), "Initial Principal:")
    t3.setSize(14)
    t3.draw(win)

    prinBox = Entry(Point(4.25,6), 6)
    prinBox.draw(win)
    prinBox.setText("2000")

    t4 = Text(Point(6,6), "Annual Interest Rate:")
    t4.setSize(14)
    t4.draw(win)

    aprBox = Entry(Point(7.5,6), 5)
    aprBox.setText("0.05")
    aprBox.draw(win)
