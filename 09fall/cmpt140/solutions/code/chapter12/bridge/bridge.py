...
class Card:
    ...
    def precedes(self, other):
        # RETURNS: True if self precedes other in the "standard ordering"
...
def compareCards(c1, c2):
    # An appropriate comparison to sort cards with the built-in
...
def introduction():
    ...
    print "the points for each and and whether the hand can open."
    print
    print "The deck of cards can be generated randomly, or read from a file."
    print
    
def getDeck():
    choice = raw_input('Press "r" for random deck, or "f" for file: ')
    if choice[0] == 'r' or choice[0] == 'R':
        fileStr = ""
    else:
        fileStr = raw_input("Enter file name: ")
    return Deck(fileStr)
